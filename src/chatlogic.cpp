...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot localStack = ChatBot("../images/chatbot.png");
    localStack.SetChatLogicHandle(this);
    localStack.SetRootNode(rootNode);
    _chatBot = &localStack;
    
    //_chatBot->SetRootNode(rootNode);
    

    rootNode->MoveChatbotHere(std::move((localStack)));
